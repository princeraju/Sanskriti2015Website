...
<body>
   <?php
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        <p>Name: <input name="name" type="text" value="<?php echo $name;?>" required></p>
        <p>Message: <input name="message" type="text" value="<?php echo $message;?>" style="width:700px; max-width:95%;" placeholder="Optional, Leave Blank if not necessary"></p>
